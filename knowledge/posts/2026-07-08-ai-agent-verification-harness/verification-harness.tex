...
\node[font=\bfseries\fontsize{18}{23}\selectfont,text=navy,align=center,text width=14.6cm] at (8,8.82) {90\% 的時間，消失在重複確認裡};
\node[font=\fontsize{10.3}{13.8}\selectfont,text=muted,align=center,text width=13.8cm] at (8,7.94) {Agent 能做事，不代表系統知道它有沒有做對};

\draw[rounded corners=10pt,fill=goldsoft,draw=gold,line width=1pt] (.75,2.35) rectangle (5.15,7.15);
\node[font=\bfseries\fontsize{11.5}{14.5}\selectfont,text=navy,align=center,text width=2.85cm] at (2.95,6.68) {人工試一次};
\node[font=\fontsize{8.1}{10.3}\selectfont,text=muted,align=center,text width=2.7cm] at (2.95,6.14) {每次都靠人眼判斷};
\foreach \y/\t in {5.35/開瀏覽器,4.68/貼 prompt,4.01/看結果,3.34/猜哪裡壞}{
...
\node[font=\bfseries\fontsize{11.5}{14.5}\selectfont,text=navy,align=center,text width=2.85cm] at (11.4,6.68) {驗證線路};
\node[font=\fontsize{8.1}{10.3}\selectfont,text=muted,align=center,text width=2.7cm] at (11.4,6.14) {每次改動都能自動重跑};
