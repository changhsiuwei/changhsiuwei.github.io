...
所以我不太喜歡把這件事說成「幫助弱勢學生」。那句話聽起來善良，卻容易把學生固定在被照顧的位置。比較準確的說法是：課堂本來就有語言成本，只是某些學生替我們把成本顯影出來。當我們把逐字稿、術語表和母語橋接做好，本地學生也會受益，因為很多人其實也只是用熟悉語言掩蓋不熟悉概念。
...
逐字稿最有用的地方，不是讓學生偷懶，而是讓課堂可以被重新檢查。教師可以回頭看自己在哪裡跳太快，學生可以回頭聽自己哪一步掉隊。這份文字不是要取代上課，而是讓上課不再只存在於當下。對語言負荷重的學生來說，能回到某一句話，就是能重新進入一次課堂。
...
我會讓詞表保留「錯誤理解」欄位。不要只留下正確定義，因為學生真正會踩到的是錯誤版本。variance 被理解成一般差異，overhead 被理解成頭頂上的費用，materiality 被理解成材料性，這些笑起來很輕，但它們會讓整個概念走偏。把錯誤理解放進詞表，不是嘲笑學生，而是讓下一個學生少走一段冤枉路。
...
這裡也要教學生一個很實用的習慣：遇到太順的翻譯，先問它少了什麼。專業語言常常不順，因為它背後有制度、責任和限制。AI 很會把不順的東西翻得好讀，但好讀不一定好用。教師的工作不是讓每個詞變漂亮，而是保留那些會影響判斷的邊界。
...
這種不舒服很值得保留。教師若只想要一份漂亮摘要，就看不見自己的省略。逐字稿裡那些停頓、重複、突然換例子的地方，往往就是學生掉隊的地方。多語言支援不是替教師遮醜，而是讓教師知道下一次要在哪裡多鋪一塊踏板。
