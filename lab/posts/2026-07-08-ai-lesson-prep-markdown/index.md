...
categories:
  ...
  - 教材製作
  - Markdown
description: "AI 真正能幫教師的地方，不是憑空生成一堂課，而是把來源、版本、學生反應與教師自己的講法整理成可回頭檢查的教材記憶。"
...
Notion 可以當工作桌，NotebookLM 可以協助在來源裡查找，Markdown 則像砧板。砧板不負責做菜，但沒有砧板，材料會散得到處都是。AI 時代的備課不是把每個工具都用上，而是讓工具各自待在它該待的位置。來源管理、文本骨架、生成輔助、版本保存，這些工作若混在一起，教師很快就會失去對教材的控制。
