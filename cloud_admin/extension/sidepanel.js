    ...
    if (section === "about") {
      ...
      if (trimmed.startsWith("::: {.g-col-12 .g-col-md-5}")) {
        curHonor = {
          ...
          badge: "Deloitte 勤業眾信 · 產學榮譽（達人軍）",
          title: "2026 勤業眾信稅務達人挑戰賽 · 榮獲「達人軍」",
          desc: "茲感謝勤業眾信聯合會計師事務所（Deloitte Taiwan）稅務暨法律部門頒發感謝狀，致謝張修瑋老師帶領國立臺北大學會計學系優秀代表隊投入全國性稅務競賽，榮獲「達人軍」殊榮，肯定卓越之教學指導與產學培育成果。",
...
function serializeHomePage(model, lineEnding = "\n") {
  ...
  const honorBlocks = (model.honors || []).map((h) => {
    const cardBlock = [
      ...
      `  <span class="badge bg-primary" style="font-size:12px;padding:5px 10px;">${h.badge || "Deloitte 勤業眾信 · 產學榮譽（達人軍）"}</span>`,
      `</div>`,
      `<h3 style="margin:4px 0 12px;font-size:20px;color:#001F3F;font-weight:700;">${h.title || "2026 勤業眾信稅務達人挑戰賽 · 榮獲「達人軍」"}</h3>`,
      `<p style="margin:0 0 14px;color:#475569;font-size:14px;line-height:1.6;">`,
      `  ${h.desc || "茲感謝勤業眾信聯合會計師事務所（Deloitte Taiwan）稅務暨法律部門頒發感謝狀，致謝張修瑋老師帶領國立臺北大學會計學系優秀代表隊投入全國性稅務競賽，榮獲「達人軍」殊榮，肯定卓越之教學指導與產學培育成果。"}`,
      `</p>`,
